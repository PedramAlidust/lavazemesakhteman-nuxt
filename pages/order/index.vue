<template>
    <section class="ProductPriceBkg">
                  ...
                  <section>
                        ...
                        <div class="container bg-white Content mt-5 rounded py-5">
                          <div class="row px-4 content">
                                <!--  If is cartItem -->
                                    <table dir="rtl" v-if="DspCart.length" class="table table-striped table-bordered">
                                          <thead>
                                              <tr>
                                                  <th>نام</th>
                                                  <th>قیمت</th>
                                          ...
                                          <tbody>
                                              <tr v-for="product in DspCart" :key="product.id">
                                                  ...
                                                  <td>
                                                      ...
                                                      class="DelWidth" src="~/assets/pictures/delete.png" alt="delete">
                                                  </td>
                                              </tr>
                                          </tbody>
                                    </table>
                                  <!--  If is not cartItem -->
                                  <div v-if="!DspCart.length" class="d-flex container align-items-center justify-content-center">
                  ...
                  <!-- compare factor -->
                      <section>
                        ...
                        <div class="container bg-white Content mt-5 rounded py-5">
                          <div class="row px-4 content">
                                <!--  If is cartItem -->
                                    <table dir="rtl" v-if="DspCpmpareCart.length" class="table table-striped table-bordered">
                                          <thead>
                                              <tr>
                                                  <th>نام</th>
                                                  <th>قیمت</th>
                                  ...
                                  <!--  If is not cartItem -->
                                  <div v-if="!DspCpmpareCart.length" class="d-flex container align-items-center justify-content-center">
        ...
        <!-- compare brand section -->
                      ...
                      <div class="container bg-white Content rounded p-5">
                        <div class="row">
                          <div class="col-lg-4 col-md-4">
                                <button @click="compareAction" class="btn btn-danger btn-md">مقایسه</button>
                          </div>
                          <div class="col-lg-4 col-md-4">
                              <select @change="handleSelectionChange" dir="rtl" class="form-select">
                                  <option v-for="subcat in  DspSubCategory" :key="subcat.id" :value="subcat.id">
                  ...
                  <!-- compare table -->
                  <section>      
                      <p class="CompareTitle text-center pt-5 fw-bold">مقایسه با {{ SubCatText }}</p>
                        <div class="container bg-white Content mt-5 rounded py-5">
                          <div class="row px-4 content">
                                <!--  If is cartItem -->
                                    <table dir="rtl" class="table table-striped table-bordered">
                                          ...
                                          <tbody>
                                              <template v-for="product in DspFltProducts">
                                                  <tr v-for="(productdetail, index) in product.acf.productdetails" :key="index + Math.random().toString(36).substr(2, 10)">
                                                      <td>{{ productdetail.themodel }}</td>
                                                      <td>{{ productdetail.price }}</td>
                                                      <td>1</td>
                                                      <td>تصویر موجود نیست</td>
                                                      <td>
                                                            <button @click="AddCompareCart(productdetail.themodel, productdetail.price)" 
                                  ...
                                  <!--  If is not cartItem -->
                                  <div v-if="!DspFltProducts" class="d-flex container align-items-center justify-content-center">
                  ...
                  <section>
                      <div class="container py-5 text-center">
                        <div class="row">
                          <VueSlickCarousel v-if="DspSubCategory[0]" :slidesPerRow="3" :arrows="true" :dots="true">
...
export default {
  ...
  data() {
    ...
    computed: {
    ...mapGetters(["DspCart", "DspPosts", "DspSubCategory", "DspFltProducts", "DspCpmpareCart"]), 
    CartTotalPrice() {
       return this.DspCart
   ...
   methods: {
    ...mapActions(["GetPosts", "GetSubCategory", "DeleteCart", "SetDeleteCompareCart",  "GetProducts", "SetCompareCart", "SetFilterFltProducts"]),
    deleteCartItem(id) {
        this.DeleteCart({
            id: id
        })
