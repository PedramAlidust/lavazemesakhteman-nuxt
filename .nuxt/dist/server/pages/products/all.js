...
module.exports.__inject__ = function (context) {
  add("8780b37a", content, true, context)
};
...
/* harmony import */ var _node_modules_vue_style_loader_index_js_ref_3_oneOf_1_0_node_modules_css_loader_dist_cjs_js_ref_3_oneOf_1_1_node_modules_vue_loader_lib_loaders_stylePostLoader_js_node_modules_postcss_loader_src_index_js_ref_3_oneOf_1_2_node_modules_vue_loader_lib_index_js_vue_loader_options_all_vue_vue_type_style_index_0_id_c3d765e6_prod_scoped_true_lang_css___WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(102);
/* harmony import */ var _node_modules_vue_style_loader_index_js_ref_3_oneOf_1_0_node_modules_css_loader_dist_cjs_js_ref_3_oneOf_1_1_node_modules_vue_loader_lib_loaders_stylePostLoader_js_node_modules_postcss_loader_src_index_js_ref_3_oneOf_1_2_node_modules_vue_loader_lib_index_js_vue_loader_options_all_vue_vue_type_style_index_0_id_c3d765e6_prod_scoped_true_lang_css___WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(_node_modules_vue_style_loader_index_js_ref_3_oneOf_1_0_node_modules_css_loader_dist_cjs_js_ref_3_oneOf_1_1_node_modules_vue_loader_lib_loaders_stylePostLoader_js_node_modules_postcss_loader_src_index_js_ref_3_oneOf_1_2_node_modules_vue_loader_lib_index_js_vue_loader_options_all_vue_vue_type_style_index_0_id_c3d765e6_prod_scoped_true_lang_css___WEBPACK_IMPORTED_MODULE_0__);
/* harmony reexport (unknown) */ for(var __WEBPACK_IMPORT_KEY__ in _node_modules_vue_style_loader_index_js_ref_3_oneOf_1_0_node_modules_css_loader_dist_cjs_js_ref_3_oneOf_1_1_node_modules_vue_loader_lib_loaders_stylePostLoader_js_node_modules_postcss_loader_src_index_js_ref_3_oneOf_1_2_node_modules_vue_loader_lib_index_js_vue_loader_options_all_vue_vue_type_style_index_0_id_c3d765e6_prod_scoped_true_lang_css___WEBPACK_IMPORTED_MODULE_0__) if(["default"].indexOf(__WEBPACK_IMPORT_KEY__) < 0) (function(key) { __webpack_require__.d(__webpack_exports__, key, function() { return _node_modules_vue_style_loader_index_js_ref_3_oneOf_1_0_node_modules_css_loader_dist_cjs_js_ref_3_oneOf_1_1_node_modules_vue_loader_lib_loaders_stylePostLoader_js_node_modules_postcss_loader_src_index_js_ref_3_oneOf_1_2_node_modules_vue_loader_lib_index_js_vue_loader_options_all_vue_vue_type_style_index_0_id_c3d765e6_prod_scoped_true_lang_css___WEBPACK_IMPORTED_MODULE_0__[key]; }) }(__WEBPACK_IMPORT_KEY__));
...
// Module
___CSS_LOADER_EXPORT___.push([module.i, ".ProductImg[data-v-c3d765e6]{width:250px;height:250px}.bgbanerimg[data-v-c3d765e6]{border-radius:12px}.bigimgtxt[data-v-c3d765e6]{font-weight:700;font-size:16pt}.PostItemDesc[data-v-c3d765e6]{font-size:11pt}.bigimgtxtdesc[data-v-c3d765e6]{font-size:12pt}.PostItemTitle[data-v-c3d765e6]{font-weight:700}.CatBtn[data-v-c3d765e6]{background-color:#be2623;color:#fff;border-radius:8px;box-shadow:none;padding:8px 24px;border:none}.BlogTxt[data-v-c3d765e6]{font-weight:700;font-size:18pt}.CatTxt[data-v-c3d765e6],.ProdTitle[data-v-c3d765e6]{color:#000;font-weight:700}.CatTxt[data-v-c3d765e6]{font-size:23px;margin:0;padding:0}.slick-slide[data-v-c3d765e6]{margin:10px}.PdfTitle[data-v-c3d765e6]{font-size:14pt}.DownloadBtn[data-v-c3d765e6]{border-radius:5px;padding:8px 20px;background-color:#23a455;box-shadow:none}.CardLook[data-v-c3d765e6]{padding:15px 15px 0!important;background-color:#fff;box-shadow:0 5px 15px 1px rgba(0,0,0,.06);border-radius:8px}.PrdPrcTitle[data-v-c3d765e6]{font-size:20pt;color:#fff}.ProductPriceBkg[data-v-c3d765e6]{background-color:#0e3746}.Content[data-v-c3d765e6]{filter:drop-shadow(0 4px 4px rgba(0,0,0,0)) drop-shadow(0 4px 4px rgba(0,0,0,.25))}.PostItemTitle[data-v-c3d765e6]{color:#fff}", ""]);
// Exports
...
// CONCATENATED MODULE: ./node_modules/babel-loader/lib??ref--2-0!./node_modules/vue-loader/lib/loaders/templateLoader.js??ref--6!./node_modules/vue-loader/lib??vue-loader-options!./pages/products/all.vue?vue&type=template&id=c3d765e6&scoped=true&
var render = function render() {
  ...
  return _c('section', {
  ...
  }, [_c('TheHeader'), _vm._ssrNode(" "), _vm._ssrNode("<main class=\"pb-5 mb-5\" data-v-c3d765e6>", "</main>", [_vm._ssrNode((_vm.$route.query.title ? "<h1 class=\"PrdPrcTitle text-center pt-5 fw-bold\" data-v-c3d765e6>" + _vm._ssrEscape("\n      " + _vm._s(_vm.$route.query.title) + "\n    ") + "</h1>" : "<!---->") + " " + (!_vm.$route.query.title ? "<h1 class=\"PrdPrcTitle text-center pt-5 fw-bold\" data-v-c3d765e6>\n      تمامی محصولات لوازم ساختمانی\n    </h1>" : "<!---->") + " <div class=\"container bg-white Content my-5 rounded py-4\" data-v-c3d765e6><div dir=\"rtl\" class=\"row px-4 content\" data-v-c3d765e6><input type=\"text\" placeholder=\"محصول مورد نظر خود را سرچ کنید\"" + _vm._ssrAttr("value", _vm.SeProduct) + " class=\"form-control\" data-v-c3d765e6></div></div> "), _vm._ssrNode("<section class=\"pt-lg-5\" data-v-c3d765e6>", "</section>", [_vm._ssrNode("<div class=\"container text-center\" data-v-c3d765e6>", "</div>", [_vm._ssrNode("<div dir=\"rtl\" class=\"row\" data-v-c3d765e6>", "</div>", _vm._l(_vm.AllProductDetails, function (product) {
    return _vm._ssrNode("<div class=\"col-lg-3\" data-v-c3d765e6>", "</div>", [_vm._ssrNode("<div class=\"CardLook\" data-v-c3d765e6>", "</div>", [_c('nuxt-link', {
      attrs: {
        "to": `/product/single/?title=${product.themodel}&id=${product.id}`
      }
    }, [product.modelpicture ? _c('img', {
      staticClass: "ProductImg",
      attrs: {
        "src": product.modelpicture,
        "alt": "CatJpg"
      }
    }) : _vm._e(), _vm._v(" "), !product.modelpicture ? _c('img', {
      staticClass: "w-100",
      attrs: {
    ...
    }, [_vm._v("\n                    " + _vm._s(product.themodel) + "\n                  ")])])], 2), _vm._ssrNode(" "), _vm._ssrNode("<div class=\"text-start pb-5\" data-v-c3d765e6>", "</div>", [_vm._ssrNode("<div class=\"fw-bold text-white ps-2 pb-2\" data-v-c3d765e6>" + _vm._ssrEscape("قیمت به تومان: " + _vm._s(product.price)) + "</div> <div class=\"rounded py-2 ps-2 bg-light text-success\" data-v-c3d765e6>وضعیت: موجود</div> "), _c('nuxt-link', {
      attrs: {
        "to": `/product/single/?title=${product.themodel}&id=${product.id}`
      }
    }, [_c('div', {
      staticClass: "rounded py-2 ps-2 fw-bold bg-danger text-white mt-2"
    }, [_vm._v("سفارش محصول")])])], 2)], 2);
  }), 0)]), _vm._ssrNode(" " + (_vm.Products.length == 0 ? "<div class=\"container bg-white Content mt-2 rounded py-4\" data-v-c3d765e6><div dir=\"rtl\" class=\"row px-4 content\" data-v-c3d765e6><p class=\"text-center\" data-v-c3d765e6>محصولی یافت نشد</p></div></div>" : "<!---->"))], 2)], 2), _vm._ssrNode(" "), _c('TheFooter')], 2);
};

var staticRenderFns = [];

// CONCATENATED MODULE: ./pages/products/all.vue?vue&type=template&id=c3d765e6&scoped=true&
...
// CONCATENATED MODULE: ./node_modules/babel-loader/lib??ref--2-0!./node_modules/vue-loader/lib??vue-loader-options!./pages/products/all.vue?vue&type=script&lang=js&
...
/* harmony default export */ var allvue_type_script_lang_js_ = ({
  ...
  async asyncData(context) {
    ...
    if (!context.query.categoryid && !context.query.subcategoryid) {
      const apiUrl = `${"https://www.ostadshabake.ir"}/wp-json/wp/v2/products/?per_page=100`; // Fetch products

      return external_axios_default.a.get(apiUrl).then(productsResponse => {
        // Initialize an empty array to collect all details
        let allProductDetails = []; // Loop through each product and extract the desired details
        ...
        return {
          ...
          // Optionally include original products data
...
// CONCATENATED MODULE: ./pages/products/all.vue?vue&type=script&lang=js&
 /* harmony default export */ var products_allvue_type_script_lang_js_ = (allvue_type_script_lang_js_); 
// EXTERNAL MODULE: ./node_modules/vue-loader/lib/runtime/componentNormalizer.js
var componentNormalizer = __webpack_require__(6);

// CONCATENATED MODULE: ./pages/products/all.vue
...
var component = Object(componentNormalizer["a" /* default */])(
  products_allvue_type_script_lang_js_,
  render,
  staticRenderFns,
  false,
  injectStyles,
...
/* harmony default export */ var products_all = __webpack_exports__["default"] = (component.exports);
