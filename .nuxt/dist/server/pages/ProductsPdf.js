...
// CONCATENATED MODULE: ./node_modules/babel-loader/lib??ref--2-0!./node_modules/vue-loader/lib/loaders/templateLoader.js??ref--6!./node_modules/vue-loader/lib??vue-loader-options!./pages/ProductsPdf.vue?vue&type=template&id=70526fcf&scoped=true&
var render = function render() {
  ...
  }, [_c('TheHeader'), _vm._ssrNode(" "), _vm._ssrNode("<main class=\"pb-5 mb-5\" data-v-70526fcf>", "</main>", [_vm._ssrNode("<h1 class=\"PrdPrcTitle text-center pt-5 fw-bold\" data-v-70526fcf>لیست قیمت محصولات</h1> <div class=\"container bg-white Content mt-5 rounded py-5\" data-v-70526fcf>" + (_vm.DspPriceList ? "<div class=\"row px-4\" data-v-70526fcf>" + _vm._ssrList(_vm.DspPriceList, function (price) {
    return "<div class=\"col-lg-3 py-3\" data-v-70526fcf><div class=\"ListCardLook text-center\" data-v-70526fcf><div data-v-70526fcf><img" + _vm._ssrAttr("src", price.acf.pdfimage) + " alt=\"CatJpg\" class=\"w-100\" data-v-70526fcf></div> <div class=\"py-3\" data-v-70526fcf><p class=\"PdfTitle fw-bold text-center me-2\" data-v-70526fcf>" + _vm._ssrEscape(_vm._s(price.acf.pdftitle)) + "</p> <a target=\"_blank\"" + _vm._ssrAttr("href", price.acf.thepdf) + " data-v-70526fcf><button type=\"button\" class=\"DownloadBtn btn-sm btn text-white\" data-v-70526fcf>\n                                    دانلود لیست قیمت\n                                  </button></a></div></div></div>";
  }) + "</div>" : "<!---->") + "</div> <section data-v-70526fcf><div class=\"container pt-5 pb-4\" data-v-70526fcf><div class=\"d-flex align-items-center justify-content-end\" data-v-70526fcf><p class=\"CatTxt\" data-v-70526fcf>آخرین محصولات</p></div></div></section> "), _vm._ssrNode("<section data-v-70526fcf>", "</section>", [_vm._ssrNode("<div class=\"container py-5 text-center\" data-v-70526fcf>", "</div>", [_vm._ssrNode("<div class=\"row\" data-v-70526fcf>", "</div>", _vm._l(_vm.DspSubCategory, function (subcategory) {
    return _vm._ssrNode("<div class=\"col-lg-3\" data-v-70526fcf>", "</div>", [_vm._ssrNode("<div class=\"CardLook\" data-v-70526fcf>", "</div>", [_c('nuxt-link', {
      attrs: {
  ...
  }), 0)])]), _vm._ssrNode(" <section class=\"py-5\" data-v-70526fcf><div class=\"container\" data-v-70526fcf><div class=\"d-flex align-items-center justify-content-between\" data-v-70526fcf><button role=\"button\" class=\"CatBtn\" data-v-70526fcf>مشاهده همه</button> <p class=\"BlogTxt\" data-v-70526fcf>مطالب وبلاگ</p></div></div></section> "), _vm._ssrNode("<section data-v-70526fcf>", "</section>", [_vm._ssrNode("<div class=\"container pb-5\" data-v-70526fcf>", "</div>", [_vm._ssrNode("<div class=\"row\" data-v-70526fcf>", "</div>", [_vm._ssrNode("<div class=\"col-lg-8\" data-v-70526fcf>", "</div>", [_vm._ssrNode("<div class=\"container-full\" data-v-70526fcf>", "</div>", [_vm._ssrNode("<div class=\"row gx-3\" data-v-70526fcf>", "</div>", _vm._l(_vm.DspPosts, function (post) {
    return _vm._ssrNode("<div class=\"col-lg-4\" data-v-70526fcf>", "</div>", [_vm._ssrNode("<div class=\"bg-image\" data-v-70526fcf>" + (post.acf.postpic ? "<img" + _vm._ssrAttr("src", post.acf.postpic) + " alt=\"bgbaner\" class=\"bgbanerimg w-100\" data-v-70526fcf>" : "<!---->") + " " + (!post.acf.postpic ? "<img" + _vm._ssrAttr("src", __webpack_require__(46)) + " alt=\"CatJpg\" class=\"w-100\" data-v-70526fcf>" : "<!---->") + " <div class=\"mask\" style=\"border-radius: 12px; background: linear-gradient(359.73deg, #000000 -30.17%, rgba(217, 217, 217, 0) 12.75%);\" data-v-70526fcf></div></div> "), _c('nuxt-link', {
      attrs: {
  ...
  }), 0)])]), _vm._ssrNode(" <div class=\"col-lg-4\" data-v-70526fcf><div class=\"bg-image\" data-v-70526fcf><img" + _vm._ssrAttr("src", __webpack_require__(56)) + " alt=\"bgbaner\" class=\"bgbanerimg w-100\" data-v-70526fcf> <div class=\"mask\" style=\"border-radius: 12px; background: linear-gradient(359.73deg, #000000 -30.17%, rgba(217, 217, 217, 0) 80.75%);\" data-v-70526fcf><div class=\"d-flex flex-column text-start h-100\" data-v-70526fcf><p class=\"bigimgtxt text-white mb-0 pb-2 ps-4\" style=\"margin-top: auto;\" data-v-70526fcf>وبلاگ ما</p> <p dir=\"rtl\" class=\"bigimgtxtdesc text-white mb-0 pb-5 ps-4\" data-v-70526fcf>در قسمت وبلاگ مطالب مهم آموزشی و اخبار لوازم ساختمان را قرار داده ایم</p></div></div></div></div>")], 2)])])], 2), _vm._ssrNode(" "), _c('TheFooter')], 2);
};

var staticRenderFns = [];

// CONCATENATED MODULE: ./pages/ProductsPdf.vue?vue&type=template&id=70526fcf&scoped=true&
...
// CONCATENATED MODULE: ./node_modules/babel-loader/lib??ref--2-0!./node_modules/vue-loader/lib??vue-loader-options!./pages/ProductsPdf.vue?vue&type=script&lang=js&



/* harmony default export */ var ProductsPdfvue_type_script_lang_js_ = ({
  components: {
    TheHeader: TheHeader["a" /* default */],
    TheFooter: TheFooter["a" /* default */]
  },
  computed: { ...Object(external_vuex_["mapGetters"])(["DspPriceList", "DspPosts", "DspSubCategory"])
  },
  methods: { ...Object(external_vuex_["mapActions"])(["GetpriceList", "GetPosts", "GetSubCategory"])
  },
...
// CONCATENATED MODULE: ./pages/ProductsPdf.vue?vue&type=script&lang=js&
 /* harmony default export */ var pages_ProductsPdfvue_type_script_lang_js_ = (ProductsPdfvue_type_script_lang_js_); 
// EXTERNAL MODULE: ./node_modules/vue-loader/lib/runtime/componentNormalizer.js
var componentNormalizer = __webpack_require__(5);

// CONCATENATED MODULE: ./pages/ProductsPdf.vue
...
var component = Object(componentNormalizer["a" /* default */])(
  pages_ProductsPdfvue_type_script_lang_js_,
  render,
  staticRenderFns,
  false,
  injectStyles,
...
/* harmony default export */ var ProductsPdf = __webpack_exports__["default"] = (component.exports);
...
var add = __webpack_require__(4).default
module.exports.__inject__ = function (context) {
  add("1923ab6c", content, true, context)
};
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _node_modules_vue_style_loader_index_js_ref_3_oneOf_1_0_node_modules_css_loader_dist_cjs_js_ref_3_oneOf_1_1_node_modules_vue_loader_lib_loaders_stylePostLoader_js_node_modules_postcss_loader_src_index_js_ref_3_oneOf_1_2_node_modules_vue_loader_lib_index_js_vue_loader_options_ProductsPdf_vue_vue_type_style_index_0_id_70526fcf_prod_scoped_true_lang_css___WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(66);
/* harmony import */ var _node_modules_vue_style_loader_index_js_ref_3_oneOf_1_0_node_modules_css_loader_dist_cjs_js_ref_3_oneOf_1_1_node_modules_vue_loader_lib_loaders_stylePostLoader_js_node_modules_postcss_loader_src_index_js_ref_3_oneOf_1_2_node_modules_vue_loader_lib_index_js_vue_loader_options_ProductsPdf_vue_vue_type_style_index_0_id_70526fcf_prod_scoped_true_lang_css___WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(_node_modules_vue_style_loader_index_js_ref_3_oneOf_1_0_node_modules_css_loader_dist_cjs_js_ref_3_oneOf_1_1_node_modules_vue_loader_lib_loaders_stylePostLoader_js_node_modules_postcss_loader_src_index_js_ref_3_oneOf_1_2_node_modules_vue_loader_lib_index_js_vue_loader_options_ProductsPdf_vue_vue_type_style_index_0_id_70526fcf_prod_scoped_true_lang_css___WEBPACK_IMPORTED_MODULE_0__);
/* harmony reexport (unknown) */ for(var __WEBPACK_IMPORT_KEY__ in _node_modules_vue_style_loader_index_js_ref_3_oneOf_1_0_node_modules_css_loader_dist_cjs_js_ref_3_oneOf_1_1_node_modules_vue_loader_lib_loaders_stylePostLoader_js_node_modules_postcss_loader_src_index_js_ref_3_oneOf_1_2_node_modules_vue_loader_lib_index_js_vue_loader_options_ProductsPdf_vue_vue_type_style_index_0_id_70526fcf_prod_scoped_true_lang_css___WEBPACK_IMPORTED_MODULE_0__) if(["default"].indexOf(__WEBPACK_IMPORT_KEY__) < 0) (function(key) { __webpack_require__.d(__webpack_exports__, key, function() { return _node_modules_vue_style_loader_index_js_ref_3_oneOf_1_0_node_modules_css_loader_dist_cjs_js_ref_3_oneOf_1_1_node_modules_vue_loader_lib_loaders_stylePostLoader_js_node_modules_postcss_loader_src_index_js_ref_3_oneOf_1_2_node_modules_vue_loader_lib_index_js_vue_loader_options_ProductsPdf_vue_vue_type_style_index_0_id_70526fcf_prod_scoped_true_lang_css___WEBPACK_IMPORTED_MODULE_0__[key]; }) }(__WEBPACK_IMPORT_KEY__));
...
// Module
___CSS_LOADER_EXPORT___.push([module.i, ".bgbanerimg[data-v-70526fcf]{border-radius:12px}.bigimgtxt[data-v-70526fcf]{font-weight:700;font-size:16pt}.PostItemDesc[data-v-70526fcf]{font-size:11pt}.bigimgtxtdesc[data-v-70526fcf]{font-size:12pt}.PostItemTitle[data-v-70526fcf]{font-weight:700}.CatBtn[data-v-70526fcf]{background-color:#23a455;color:#fff;border-radius:8px;box-shadow:none;padding:8px 24px;border:none}.BlogTxt[data-v-70526fcf]{font-size:18pt}.BlogTxt[data-v-70526fcf],.CatTxt[data-v-70526fcf],.ProdTitle[data-v-70526fcf]{font-weight:700}.CatTxt[data-v-70526fcf]{color:#000;font-size:23px;margin:0;padding:0}.slick-slide[data-v-70526fcf]{margin:10px}.PdfTitle[data-v-70526fcf]{font-size:14pt}.DownloadBtn[data-v-70526fcf]{border-radius:5px;padding:8px 20px;background-color:#23a455;box-shadow:none}.CardLook[data-v-70526fcf]{padding:15px!important}.CardLook[data-v-70526fcf],.ListCardLook[data-v-70526fcf]{background-color:#fff;box-shadow:0 5px 15px 1px rgba(0,0,0,.06);border-radius:8px}.ListCardLook[data-v-70526fcf]{padding:15px 15px 0!important}.PrdPrcTitle[data-v-70526fcf]{font-size:20pt;color:#fff}.ProductPriceBkg[data-v-70526fcf]{background-image:url(" + ___CSS_LOADER_URL_REPLACEMENT_0___ + ");background-position:top;background-repeat:no-repeat;background-size:cover}.Content[data-v-70526fcf]{filter:drop-shadow(0 4px 4px rgba(0,0,0,0)) drop-shadow(0 4px 4px rgba(0,0,0,.25))}.PostItemTitle[data-v-70526fcf]{color:#000}", ""]);
// Exports
module.exports = ___CSS_LOADER_EXPORT___;
...
//# sourceMappingURL=ProductsPdf.js.map