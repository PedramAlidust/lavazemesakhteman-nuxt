...
/* harmony import */ var _node_modules_vue_style_loader_index_js_ref_3_oneOf_1_0_node_modules_css_loader_dist_cjs_js_ref_3_oneOf_1_1_node_modules_vue_loader_lib_loaders_stylePostLoader_js_node_modules_postcss_loader_src_index_js_ref_3_oneOf_1_2_node_modules_vue_loader_lib_index_js_vue_loader_options_ProductsPdf_vue_vue_type_style_index_0_id_c5e3b88a_prod_scoped_true_lang_css___WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(97);
/* harmony import */ var _node_modules_vue_style_loader_index_js_ref_3_oneOf_1_0_node_modules_css_loader_dist_cjs_js_ref_3_oneOf_1_1_node_modules_vue_loader_lib_loaders_stylePostLoader_js_node_modules_postcss_loader_src_index_js_ref_3_oneOf_1_2_node_modules_vue_loader_lib_index_js_vue_loader_options_ProductsPdf_vue_vue_type_style_index_0_id_c5e3b88a_prod_scoped_true_lang_css___WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(_node_modules_vue_style_loader_index_js_ref_3_oneOf_1_0_node_modules_css_loader_dist_cjs_js_ref_3_oneOf_1_1_node_modules_vue_loader_lib_loaders_stylePostLoader_js_node_modules_postcss_loader_src_index_js_ref_3_oneOf_1_2_node_modules_vue_loader_lib_index_js_vue_loader_options_ProductsPdf_vue_vue_type_style_index_0_id_c5e3b88a_prod_scoped_true_lang_css___WEBPACK_IMPORTED_MODULE_0__);
/* harmony reexport (unknown) */ for(var __WEBPACK_IMPORT_KEY__ in _node_modules_vue_style_loader_index_js_ref_3_oneOf_1_0_node_modules_css_loader_dist_cjs_js_ref_3_oneOf_1_1_node_modules_vue_loader_lib_loaders_stylePostLoader_js_node_modules_postcss_loader_src_index_js_ref_3_oneOf_1_2_node_modules_vue_loader_lib_index_js_vue_loader_options_ProductsPdf_vue_vue_type_style_index_0_id_c5e3b88a_prod_scoped_true_lang_css___WEBPACK_IMPORTED_MODULE_0__) if(["default"].indexOf(__WEBPACK_IMPORT_KEY__) < 0) (function(key) { __webpack_require__.d(__webpack_exports__, key, function() { return _node_modules_vue_style_loader_index_js_ref_3_oneOf_1_0_node_modules_css_loader_dist_cjs_js_ref_3_oneOf_1_1_node_modules_vue_loader_lib_loaders_stylePostLoader_js_node_modules_postcss_loader_src_index_js_ref_3_oneOf_1_2_node_modules_vue_loader_lib_index_js_vue_loader_options_ProductsPdf_vue_vue_type_style_index_0_id_c5e3b88a_prod_scoped_true_lang_css___WEBPACK_IMPORTED_MODULE_0__[key]; }) }(__WEBPACK_IMPORT_KEY__));
...
// Module
___CSS_LOADER_EXPORT___.push([module.i, ".ProductTitle[data-v-c5e3b88a]{color:#000}.bgbanerimg[data-v-c5e3b88a]{border-radius:12px}.bigimgtxt[data-v-c5e3b88a]{font-weight:700;font-size:16pt}.PostItemDesc[data-v-c5e3b88a]{font-size:11pt;color:#ebe9e2}.bigimgtxtdesc[data-v-c5e3b88a]{font-size:12pt}.PostItemTitle[data-v-c5e3b88a]{font-weight:700}.CatBtn[data-v-c5e3b88a]{background-color:#23a455}.BlogTxt[data-v-c5e3b88a],.CatBtn[data-v-c5e3b88a]{color:#fff}.CatBtn[data-v-c5e3b88a]{background-color:#be2623;border-radius:8px;box-shadow:none;padding:8px 24px;border:none}.BlogTxt[data-v-c5e3b88a]{font-size:18pt}.BlogTxt[data-v-c5e3b88a],.CatTxt[data-v-c5e3b88a],.ProdTitle[data-v-c5e3b88a]{font-weight:700}.CatTxt[data-v-c5e3b88a]{color:#fff;font-size:23px;margin:0;padding:0}.slick-slide[data-v-c5e3b88a]{margin:10px}.PdfTitle[data-v-c5e3b88a]{font-size:14pt}.DownloadBtn[data-v-c5e3b88a]{border-radius:5px;padding:8px 20px;background-color:#be2623;box-shadow:none}.CardLook[data-v-c5e3b88a]{padding:15px!important}.CardLook[data-v-c5e3b88a],.ListCardLook[data-v-c5e3b88a]{background-color:#fff;box-shadow:0 5px 15px 1px rgba(0,0,0,.06);border-radius:8px}.ListCardLook[data-v-c5e3b88a]{padding:15px 15px 0!important}.PrdPrcTitle[data-v-c5e3b88a]{font-size:20pt;color:#fff}.ProductPriceBkg[data-v-c5e3b88a]{background-color:#0e3746;background-position:top;background-repeat:no-repeat;background-size:cover}.Content[data-v-c5e3b88a]{background-color:#f4f2ec;filter:drop-shadow(0 4px 4px rgba(0,0,0,0)) drop-shadow(0 4px 4px rgba(0,0,0,.25))}.PostItemTitle[data-v-c5e3b88a]{color:#fff}", ""]);
// Exports
...
// CONCATENATED MODULE: ./node_modules/babel-loader/lib??ref--2-0!./node_modules/vue-loader/lib/loaders/templateLoader.js??ref--6!./node_modules/vue-loader/lib??vue-loader-options!./pages/ProductsPdf.vue?vue&type=template&id=c5e3b88a&scoped=true&
var render = function render() {
  ...
  }, [_c('TheHeader'), _vm._ssrNode(" "), _vm._ssrNode("<main class=\"pb-5 mb-5\" data-v-c5e3b88a>", "</main>", [_vm._ssrNode("<h1 class=\"PrdPrcTitle text-center pt-5 fw-bold\" data-v-c5e3b88a>\n      لیست قیمت محصولات لوازم ساختمان و صنعتی\n    </h1> <div class=\"container Content mt-5 rounded py-5\" data-v-c5e3b88a>" + (_vm.pdfs ? "<div dir=\"rtl\" class=\"row px-4\" data-v-c5e3b88a>" + _vm._ssrList(_vm.pdfs, function (price) {
    return "<div class=\"col-lg-3 py-3\" data-v-c5e3b88a><div class=\"ListCardLook text-center\" data-v-c5e3b88a><div data-v-c5e3b88a><img" + _vm._ssrAttr("src", price.acf.pdfimage) + " alt=\"CatJpg\" class=\"w-100\" data-v-c5e3b88a></div> <div class=\"py-3\" data-v-c5e3b88a><p class=\"PdfTitle fw-bold text-center me-2\" data-v-c5e3b88a>" + _vm._ssrEscape("\n                " + _vm._s(price.acf.pdftitle) + "\n              ") + "</p> <a target=\"_blank\"" + _vm._ssrAttr("href", price.acf.thepdf) + " data-v-c5e3b88a><button type=\"button\" class=\"DownloadBtn btn-sm btn text-white\" data-v-c5e3b88a>\n                  دانلود لیست قیمت\n                </button></a></div></div></div>";
  }) + "</div>" : "<!---->") + "</div> <section data-v-c5e3b88a><div class=\"container mt-3 pt-5 pb-4\" data-v-c5e3b88a><div class=\"d-flex align-items-center justify-content-end\" data-v-c5e3b88a><p class=\"CatTxt\" data-v-c5e3b88a>آخرین محصولات</p></div></div></section> "), _vm._ssrNode("<section data-v-c5e3b88a>", "</section>", [_vm._ssrNode("<div class=\"container py-5 text-center\" data-v-c5e3b88a>", "</div>", [_vm._ssrNode("<div class=\"row\" data-v-c5e3b88a>", "</div>", _vm._l(_vm.zirdaste, function (subcategory) {
    return _vm._ssrNode("<div class=\"col-lg-3\" data-v-c5e3b88a>", "</div>", [_vm._ssrNode("<div class=\"CardLook mb-5\" data-v-c5e3b88a>", "</div>", [_c('nuxt-link', {
      attrs: {
  ...
  }), 0)])]), _vm._ssrNode(" <section class=\"pb-5\" data-v-c5e3b88a><div class=\"container\" data-v-c5e3b88a><div class=\"d-flex align-items-center justify-content-between\" data-v-c5e3b88a><button role=\"button\" class=\"CatBtn\" data-v-c5e3b88a>مشاهده همه</button> <p class=\"BlogTxt\" data-v-c5e3b88a>مطالب وبلاگ</p></div></div></section> "), _vm._ssrNode("<section data-v-c5e3b88a>", "</section>", [_vm._ssrNode("<div class=\"container pb-5\" data-v-c5e3b88a>", "</div>", [_vm._ssrNode("<div dir=\"rtl\" class=\"row\" data-v-c5e3b88a>", "</div>", [_vm._ssrNode("<div class=\"col-lg-12\" data-v-c5e3b88a>", "</div>", [_vm._ssrNode("<div class=\"container-full\" data-v-c5e3b88a>", "</div>", [_vm._ssrNode("<div class=\"row gx-3\" data-v-c5e3b88a>", "</div>", _vm._l(_vm.Posts, function (post) {
    return _vm._ssrNode("<div class=\"col-lg-4 px-4 px-lg-4\" data-v-c5e3b88a>", "</div>", [_vm._ssrNode("<div class=\"p-lg-0 text-center\" data-v-c5e3b88a>" + (post.acf.postpic ? "<img" + _vm._ssrAttr("src", post.acf.postpic) + " alt=\"bgbaner\" class=\"w-100 bgbanerimg\" style=\"height: 300px\" data-v-c5e3b88a>" : "<!---->") + " " + (!post.acf.postpic ? "<img" + _vm._ssrAttr("src", __webpack_require__(67)) + " alt=\"CatJpg\" class=\"w-100\" data-v-c5e3b88a>" : "<!---->") + "</div> "), _c('nuxt-link', {
      attrs: {
...
// CONCATENATED MODULE: ./pages/ProductsPdf.vue?vue&type=template&id=c5e3b88a&scoped=true&
...
/* harmony default export */ var ProductsPdfvue_type_script_lang_js_ = ({
  ...
  asyncData(context) {
    ...
    const pdfs = external_axios_default.a.get(`${"https://www.ostadshabake.ir"}/wp-json/wp/v2/pdf/?per_page=100`);
    const Posts = external_axios_default.a.get(`${"https://www.ostadshabake.ir"}/wp-json/wp/v2/posts/?per_page=100`);
    return external_axios_default.a.all([zirdaste, pdfs, Posts]).then(external_axios_default.a.spread((...responses) => {
...
var add = __webpack_require__(4).default
module.exports.__inject__ = function (context) {
  add("0dd06056", content, true, context)
};
