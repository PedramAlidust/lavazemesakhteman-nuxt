...
// CONCATENATED MODULE: ./node_modules/babel-loader/lib??ref--2-0!./node_modules/vue-loader/lib/loaders/templateLoader.js??ref--6!./node_modules/vue-loader/lib??vue-loader-options!./pages/blog/about.vue?vue&type=template&id=49bbabd2&scoped=true&
var render = function render() {
  ...
  }, [_c('TheHeader'), _vm._ssrNode(" "), _vm._ssrNode("<main class=\"pb-5 mb-5\" data-v-49bbabd2>", "</main>", [_vm._ssrNode("<h1 class=\"PrdPrcTitle text-center pt-5 fw-bold\" data-v-49bbabd2>درباره ما</h1> <div class=\"container bg-white Content mt-5 rounded py-5\" data-v-49bbabd2><div dir=\"rtl\" class=\"row px-4 content\" data-v-49bbabd2><p data-v-49bbabd2> \n                مجموعه لوازم ساختمان با بیش از بیست سال تجربه مفتخر است با ارايه خدمات به شرکت ها و مراکز خصوصی دولتی و اماکن مسکونی شیرآلات و دیگر لوازم ساختمانی را عرضه می کند\n                با توجّه به مشابهت‌هایی که به لحاظ فرایند تولید، شیوهٔ بازاریابی، شیوهٔ مدیریت، حجم سرمایه، نوع ماشین‌آلات مورد استفاده، نوع موادّ اولیه ملزوم و غیره میان گروه‌های گوناگون صنعت وجود دارند،\n                گروه‌های گوناگون صنعت را می‌توان از جنبه‌های گوناگون تقسیم‌بندی کرد.\n                  </p> <p data-v-49bbabd2>\n                    در مورد تعریف دقیق «صنعت»، اختلاف نظرهای کثیری وجود دارد. صنعت دارای تعریف‌ها و تعبیرهای متفاوتی است که براساس جایگزین‌پذیری فراورده‌ها، فرایند تولید و محدوده‌های گیتاشناختی ارائه شده‌اند؛ مثلاً مایکل پورتر، صنعت را چنین تعریف می‌کند: «صنعت، عبارت اند از گروه شرکت‌هایی که فراورده‌های آنها جایگزین نزدیکی برای هم می‌باشند.\n                  </p></div></div> "), _vm._ssrNode("<section class=\"py-5\" data-v-49bbabd2>", "</section>", [_vm._ssrNode("<div class=\"container\" data-v-49bbabd2>", "</div>", [_vm._ssrNode("<div class=\"d-flex align-items-center justify-content-between\" data-v-49bbabd2>", "</div>", [_c('nuxt-link', {
    attrs: {
      "to": "/blog/"
    }
  }, [_c('button', {
  ...
  }, [_vm._v("مشاهده همه")])]), _vm._ssrNode(" <p class=\"BlogTxt\" data-v-49bbabd2>دیگر مطالب</p>")], 2)])]), _vm._ssrNode(" "), _vm._ssrNode("<section data-v-49bbabd2>", "</section>", [_vm._ssrNode("<div class=\"container pb-5\" data-v-49bbabd2>", "</div>", [_vm._ssrNode("<div class=\"row\" data-v-49bbabd2>", "</div>", [_vm._ssrNode("<div class=\"col-lg-8\" data-v-49bbabd2>", "</div>", [_vm._ssrNode("<div class=\"container-full\" data-v-49bbabd2>", "</div>", [_vm._ssrNode("<div class=\"row gx-3\" data-v-49bbabd2>", "</div>", _vm._l(_vm.DspPosts, function (post) {
    return _vm._ssrNode("<div class=\"col-lg-4\" data-v-49bbabd2>", "</div>", [_vm._ssrNode("<div class=\"bg-image\" data-v-49bbabd2>" + (post.acf.postpic ? "<img" + _vm._ssrAttr("src", post.acf.postpic) + " alt=\"bgbaner\" class=\"bgbanerimg w-100\" data-v-49bbabd2>" : "<!---->") + " " + (!post.acf.postpic ? "<img" + _vm._ssrAttr("src", __webpack_require__(46)) + " alt=\"CatJpg\" class=\"w-100\" data-v-49bbabd2>" : "<!---->") + " <div class=\"mask\" style=\"border-radius: 12px; background: linear-gradient(359.73deg, #000000 -30.17%, rgba(217, 217, 217, 0) 12.75%);\" data-v-49bbabd2></div></div> "), _c('nuxt-link', {
      attrs: {
  ...
  }), 0)])]), _vm._ssrNode(" <div class=\"col-lg-4\" data-v-49bbabd2><div class=\"bg-image\" data-v-49bbabd2><img" + _vm._ssrAttr("src", __webpack_require__(56)) + " alt=\"bgbaner\" class=\"bgbanerimg w-100\" data-v-49bbabd2> <div class=\"mask\" style=\"border-radius: 12px; background: linear-gradient(359.73deg, #000000 -30.17%, rgba(217, 217, 217, 0) 80.75%);\" data-v-49bbabd2><div class=\"d-flex flex-column text-start h-100\" data-v-49bbabd2><p class=\"bigimgtxt text-white mb-0 pb-2 ps-4\" style=\"margin-top: auto;\" data-v-49bbabd2>وبلاگ ما</p> <p dir=\"rtl\" class=\"bigimgtxtdesc text-white mb-0 pb-5 ps-4\" data-v-49bbabd2>در قسمت وبلاگ مطالب مهم آموزشی و اخبار لوازم ساختمان را قرار داده ایم</p></div></div></div></div>")], 2)])]), _vm._ssrNode(" <section data-v-49bbabd2><div class=\"container pb-4\" data-v-49bbabd2><div class=\"d-flex align-items-center justify-content-end\" data-v-49bbabd2><p class=\"CatTxt\" data-v-49bbabd2>آخرین محصولات</p></div></div></section> "), _vm._ssrNode("<section data-v-49bbabd2>", "</section>", [_vm._ssrNode("<div class=\"container py-5 text-center\" data-v-49bbabd2>", "</div>", [_vm._ssrNode("<div class=\"row\" data-v-49bbabd2>", "</div>", [_vm.DspSubCategory[0] ? _c('VueSlickCarousel', {
    attrs: {
      "slidesPerRow": 4,
      "arrows": true,
      "dots": true
...
// CONCATENATED MODULE: ./pages/blog/about.vue?vue&type=template&id=49bbabd2&scoped=true&
...
// CONCATENATED MODULE: ./node_modules/babel-loader/lib??ref--2-0!./node_modules/vue-loader/lib??vue-loader-options!./pages/blog/about.vue?vue&type=script&lang=js&
...
/* harmony default export */ var aboutvue_type_script_lang_js_ = ({
  ...
  computed: { ...Object(external_vuex_["mapGetters"])(["DspPosts", "DspSubCategory"])
  },
  methods: { ...Object(external_vuex_["mapActions"])(["GetPosts", "GetSubCategory"])
  },
...
// CONCATENATED MODULE: ./pages/blog/about.vue?vue&type=script&lang=js&
 /* harmony default export */ var blog_aboutvue_type_script_lang_js_ = (aboutvue_type_script_lang_js_); 
// EXTERNAL MODULE: ./node_modules/vue-loader/lib/runtime/componentNormalizer.js
var componentNormalizer = __webpack_require__(5);

// CONCATENATED MODULE: ./pages/blog/about.vue
...
var component = Object(componentNormalizer["a" /* default */])(
  blog_aboutvue_type_script_lang_js_,
  render,
  staticRenderFns,
  false,
  injectStyles,
...
var add = __webpack_require__(4).default
module.exports.__inject__ = function (context) {
  add("2fa95182", content, true, context)
};
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _node_modules_vue_style_loader_index_js_ref_3_oneOf_1_0_node_modules_css_loader_dist_cjs_js_ref_3_oneOf_1_1_node_modules_vue_loader_lib_loaders_stylePostLoader_js_node_modules_postcss_loader_src_index_js_ref_3_oneOf_1_2_node_modules_vue_loader_lib_index_js_vue_loader_options_about_vue_vue_type_style_index_0_id_49bbabd2_prod_scoped_true_lang_css___WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(67);
/* harmony import */ var _node_modules_vue_style_loader_index_js_ref_3_oneOf_1_0_node_modules_css_loader_dist_cjs_js_ref_3_oneOf_1_1_node_modules_vue_loader_lib_loaders_stylePostLoader_js_node_modules_postcss_loader_src_index_js_ref_3_oneOf_1_2_node_modules_vue_loader_lib_index_js_vue_loader_options_about_vue_vue_type_style_index_0_id_49bbabd2_prod_scoped_true_lang_css___WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(_node_modules_vue_style_loader_index_js_ref_3_oneOf_1_0_node_modules_css_loader_dist_cjs_js_ref_3_oneOf_1_1_node_modules_vue_loader_lib_loaders_stylePostLoader_js_node_modules_postcss_loader_src_index_js_ref_3_oneOf_1_2_node_modules_vue_loader_lib_index_js_vue_loader_options_about_vue_vue_type_style_index_0_id_49bbabd2_prod_scoped_true_lang_css___WEBPACK_IMPORTED_MODULE_0__);
/* harmony reexport (unknown) */ for(var __WEBPACK_IMPORT_KEY__ in _node_modules_vue_style_loader_index_js_ref_3_oneOf_1_0_node_modules_css_loader_dist_cjs_js_ref_3_oneOf_1_1_node_modules_vue_loader_lib_loaders_stylePostLoader_js_node_modules_postcss_loader_src_index_js_ref_3_oneOf_1_2_node_modules_vue_loader_lib_index_js_vue_loader_options_about_vue_vue_type_style_index_0_id_49bbabd2_prod_scoped_true_lang_css___WEBPACK_IMPORTED_MODULE_0__) if(["default"].indexOf(__WEBPACK_IMPORT_KEY__) < 0) (function(key) { __webpack_require__.d(__webpack_exports__, key, function() { return _node_modules_vue_style_loader_index_js_ref_3_oneOf_1_0_node_modules_css_loader_dist_cjs_js_ref_3_oneOf_1_1_node_modules_vue_loader_lib_loaders_stylePostLoader_js_node_modules_postcss_loader_src_index_js_ref_3_oneOf_1_2_node_modules_vue_loader_lib_index_js_vue_loader_options_about_vue_vue_type_style_index_0_id_49bbabd2_prod_scoped_true_lang_css___WEBPACK_IMPORTED_MODULE_0__[key]; }) }(__WEBPACK_IMPORT_KEY__));
...
// Module
___CSS_LOADER_EXPORT___.push([module.i, ".content[data-v-49bbabd2]{min-height:25vh;text-align:justify;-moz-text-align-last:right;text-align-last:right}.bgbanerimg[data-v-49bbabd2]{border-radius:12px}.bigimgtxt[data-v-49bbabd2]{font-weight:700;font-size:16pt}.PostItemDesc[data-v-49bbabd2]{font-size:11pt}.bigimgtxtdesc[data-v-49bbabd2]{font-size:12pt}.PostItemTitle[data-v-49bbabd2]{font-weight:700}.CatBtn[data-v-49bbabd2]{background-color:#23a455;color:#fff;border-radius:8px;box-shadow:none;padding:8px 24px;border:none}.BlogTxt[data-v-49bbabd2]{font-size:18pt}.BlogTxt[data-v-49bbabd2],.CatTxt[data-v-49bbabd2],.ProdTitle[data-v-49bbabd2]{font-weight:700}.CatTxt[data-v-49bbabd2]{color:#000;font-size:23px;margin:0;padding:0}.slick-slide[data-v-49bbabd2]{margin:10px}.PdfTitle[data-v-49bbabd2]{font-size:14pt}.DownloadBtn[data-v-49bbabd2]{border-radius:5px;padding:8px 20px;background-color:#23a455;box-shadow:none}.CardLook[data-v-49bbabd2]{padding:15px!important;background-color:#fff;box-shadow:0 5px 15px 1px rgba(0,0,0,.06);border-radius:8px}.PrdPrcTitle[data-v-49bbabd2]{font-size:20pt;color:#fff}.ProductPriceBkg[data-v-49bbabd2]{background-image:url(" + ___CSS_LOADER_URL_REPLACEMENT_0___ + ");background-position:top;background-repeat:no-repeat;background-size:cover}.Content[data-v-49bbabd2]{filter:drop-shadow(0 4px 4px rgba(0,0,0,0)) drop-shadow(0 4px 4px rgba(0,0,0,.25))}.PostItemTitle[data-v-49bbabd2]{color:#000}", ""]);
// Exports
module.exports = ___CSS_LOADER_EXPORT___;
