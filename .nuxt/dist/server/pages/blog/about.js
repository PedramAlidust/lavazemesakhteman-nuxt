...
/* harmony import */ var _node_modules_vue_style_loader_index_js_ref_3_oneOf_1_0_node_modules_css_loader_dist_cjs_js_ref_3_oneOf_1_1_node_modules_vue_loader_lib_loaders_stylePostLoader_js_node_modules_postcss_loader_src_index_js_ref_3_oneOf_1_2_node_modules_vue_loader_lib_index_js_vue_loader_options_about_vue_vue_type_style_index_0_id_bf29490a_prod_scoped_true_lang_css___WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(98);
/* harmony import */ var _node_modules_vue_style_loader_index_js_ref_3_oneOf_1_0_node_modules_css_loader_dist_cjs_js_ref_3_oneOf_1_1_node_modules_vue_loader_lib_loaders_stylePostLoader_js_node_modules_postcss_loader_src_index_js_ref_3_oneOf_1_2_node_modules_vue_loader_lib_index_js_vue_loader_options_about_vue_vue_type_style_index_0_id_bf29490a_prod_scoped_true_lang_css___WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(_node_modules_vue_style_loader_index_js_ref_3_oneOf_1_0_node_modules_css_loader_dist_cjs_js_ref_3_oneOf_1_1_node_modules_vue_loader_lib_loaders_stylePostLoader_js_node_modules_postcss_loader_src_index_js_ref_3_oneOf_1_2_node_modules_vue_loader_lib_index_js_vue_loader_options_about_vue_vue_type_style_index_0_id_bf29490a_prod_scoped_true_lang_css___WEBPACK_IMPORTED_MODULE_0__);
/* harmony reexport (unknown) */ for(var __WEBPACK_IMPORT_KEY__ in _node_modules_vue_style_loader_index_js_ref_3_oneOf_1_0_node_modules_css_loader_dist_cjs_js_ref_3_oneOf_1_1_node_modules_vue_loader_lib_loaders_stylePostLoader_js_node_modules_postcss_loader_src_index_js_ref_3_oneOf_1_2_node_modules_vue_loader_lib_index_js_vue_loader_options_about_vue_vue_type_style_index_0_id_bf29490a_prod_scoped_true_lang_css___WEBPACK_IMPORTED_MODULE_0__) if(["default"].indexOf(__WEBPACK_IMPORT_KEY__) < 0) (function(key) { __webpack_require__.d(__webpack_exports__, key, function() { return _node_modules_vue_style_loader_index_js_ref_3_oneOf_1_0_node_modules_css_loader_dist_cjs_js_ref_3_oneOf_1_1_node_modules_vue_loader_lib_loaders_stylePostLoader_js_node_modules_postcss_loader_src_index_js_ref_3_oneOf_1_2_node_modules_vue_loader_lib_index_js_vue_loader_options_about_vue_vue_type_style_index_0_id_bf29490a_prod_scoped_true_lang_css___WEBPACK_IMPORTED_MODULE_0__[key]; }) }(__WEBPACK_IMPORT_KEY__));
...
// Module
___CSS_LOADER_EXPORT___.push([module.i, ".ProductTitle[data-v-bf29490a]{color:#000}.bgbanerimg[data-v-bf29490a]{border-radius:12px}.bigimgtxt[data-v-bf29490a]{font-weight:700;font-size:16pt}.PostItemDesc[data-v-bf29490a]{font-size:11pt;color:#ebe9e2}.bigimgtxtdesc[data-v-bf29490a]{font-size:12pt}.PostItemTitle[data-v-bf29490a]{font-weight:700}.BlogTxt[data-v-bf29490a],.CatBtn[data-v-bf29490a]{color:#fff}.CatBtn[data-v-bf29490a]{background-color:#be2623;border-radius:8px;box-shadow:none;padding:8px 24px;border:none}.BlogTxt[data-v-bf29490a]{font-size:18pt}.BlogTxt[data-v-bf29490a],.CatTxt[data-v-bf29490a],.ProdTitle[data-v-bf29490a]{font-weight:700}.CatTxt[data-v-bf29490a]{color:#fff;font-size:23px;margin:0;padding:0}.slick-slide[data-v-bf29490a]{margin:10px}.PdfTitle[data-v-bf29490a]{font-size:14pt}.DownloadBtn[data-v-bf29490a]{border-radius:5px;padding:8px 20px;background-color:#be2623;box-shadow:none}.CardLook[data-v-bf29490a]{padding:15px!important}.CardLook[data-v-bf29490a],.ListCardLook[data-v-bf29490a]{background-color:#fff;box-shadow:0 5px 15px 1px rgba(0,0,0,.06);border-radius:8px}.ListCardLook[data-v-bf29490a]{padding:15px 15px 0!important}.PrdPrcTitle[data-v-bf29490a]{font-size:20pt;color:#fff}.ProductPriceBkg[data-v-bf29490a]{background-color:#0e3746;background-position:top;background-repeat:no-repeat;background-size:cover}.Content[data-v-bf29490a]{background-color:#f4f2ec;filter:drop-shadow(0 4px 4px rgba(0,0,0,0)) drop-shadow(0 4px 4px rgba(0,0,0,.25))}.PostItemTitle[data-v-bf29490a]{color:#fff}", ""]);
// Exports
...
// CONCATENATED MODULE: ./node_modules/babel-loader/lib??ref--2-0!./node_modules/vue-loader/lib/loaders/templateLoader.js??ref--6!./node_modules/vue-loader/lib??vue-loader-options!./pages/blog/about.vue?vue&type=template&id=bf29490a&scoped=true&
var render = function render() {
  ...
  }, [_vm._v("مشاهده همه")])]), _vm._ssrNode(" <p class=\"BlogTxt\" data-v-bf29490a>دیگر مطالب</p>")], 2)])]), _vm._ssrNode(" "), _vm._ssrNode("<section data-v-bf29490a>", "</section>", [_vm._ssrNode("<div class=\"container pt-4\" data-v-bf29490a>", "</div>", [_vm._ssrNode("<div class=\"row\" data-v-bf29490a>", "</div>", [_vm._ssrNode("<div class=\"col-lg-12\" data-v-bf29490a>", "</div>", [_vm._ssrNode("<div class=\"container-full\" data-v-bf29490a>", "</div>", [_vm._ssrNode("<div dir=\"rtl\" class=\"row gx-3\" data-v-bf29490a>", "</div>", _vm._l(_vm.Posts, function (post) {
    return _vm._ssrNode("<div class=\"col-lg-4 px-4 px-lg-4\" data-v-bf29490a>", "</div>", [_vm._ssrNode("<div class=\"p-lg-0 text-center\" data-v-bf29490a>" + (post.acf.postpic ? "<img" + _vm._ssrAttr("src", post.acf.postpic) + " alt=\"bgbaner\" class=\"w-100 bgbanerimg\" style=\"height: 300px\" data-v-bf29490a>" : "<!---->") + " " + (!post.acf.postpic ? "<img" + _vm._ssrAttr("src", __webpack_require__(67)) + " alt=\"CatJpg\" class=\"w-100\" data-v-bf29490a>" : "<!---->") + "</div> "), _c('nuxt-link', {
      attrs: {
...
// CONCATENATED MODULE: ./pages/blog/about.vue?vue&type=template&id=bf29490a&scoped=true&
...
var external_vue_slick_carousel_ = __webpack_require__(46);
...
/* harmony default export */ var aboutvue_type_script_lang_js_ = ({
  ...
  asyncData(context) {
    ...
    const Posts = external_axios_default.a.get(`${"https://www.ostadshabake.ir"}/wp-json/wp/v2/posts/?per_page=15`);
    return external_axios_default.a.all([zirdaste, Posts]).then(external_axios_default.a.spread((...responses) => {
  ...
  head() {
    return {
      ...
      meta: [{
        hid: "description",
        name: "description",
        content: "مجموعه لوازم ساختمان با بیش از بیست سال تجربه مفتخر است با ارايه خدمات به شرکت ها و مراکز خصوصی دولتی و اماکن مسکونی شیرآلات و دیگر لوازم ساختمانی را عرضه می کند"
      }]
    };
  }
...
var add = __webpack_require__(4).default
module.exports.__inject__ = function (context) {
  add("58cafa0f", content, true, context)
};
